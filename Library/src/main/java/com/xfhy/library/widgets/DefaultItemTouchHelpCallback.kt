 ...
 *
 * 官方是支持RecyclerView拖动排序与滑动删除，那就是ItemTouchHelper
 * 使用方式请看 吴小龙同学的博客:http://wuxiaolong.me/2016/12/10/ItemTouchHelper/
 *
 * <p>
 ...
 * </p>
 */
class DefaultItemTouchHelpCallback(private val onItemTouchCallbackListener: OnItemTouchCallbackListener) :
    ...
    override fun onMove(recyclerView: RecyclerView, srcViewHolder: ViewHolder, targetViewHolder: ViewHolder): Boolean {
        return onItemTouchCallbackListener.onMove(
            srcViewHolder.adapterPosition, targetViewHolder
                .adapterPosition
        )
    }
